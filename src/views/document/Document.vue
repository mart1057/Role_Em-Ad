    ...
    <div class="h-[100%] bg-white m-[10px] rounded-[10px]">
        <div class="p-[20px]">
            ...
            <div class="flex justify-between items-center mt-[24px]">
                <div class="flex ">
                    <button class="btn-create text-[12px] text-[#6B7490] font-bold" @click="openDailog = !openDailog">Create
                        Document</button>
                    <div>
                        <vs-tooltip bottom shadow not-hover  not-arrow v-model="activeTooltip3">
                            <div>
                                <button class="btn-filter text-[12px] text-[#6B7490] font-bold"
                                    @click="activeTooltip3 = !activeTooltip3">Filter</button>
                            </div>
                            <template #tooltip>
                                <div>
                                        ...
                                        <div class="flex">
                                            <div class="mr-[20px]">
                                                <div class=" w-[100%] h-[50px]">
                                                    <div class="flex">
                                                        <div class="flex justify-center items-center mr-[20px]">Favorite Document</div>
                                    ...
                                    <div class="flex justify-end mt-[-20px] mb-[10px]">
                                       <vs-button type="filled" @click="activeTooltip3 = false">Save Filter</vs-button> 
                                    </div>
        ...
        <vs-dialog not-close overflow-hidden full-screen v-model="openDailog">
            <div class="flex justify-end">
                <div @click="openDailog = !openDailog" class="cursor-pointer"><md-icon>close</md-icon></div>
            </div>
                ...
                <div class="ml-[30px]">
                    ...
                    <div class=" flex mt-[10px] mr-[10px]">
                            ...
                            <div class="flex">
                                <template>
                                    <div class="center flex">
                                        <vs-radio v-model="option" val="true">
                                            <div class="text-[10px]">Parallel</div>
                                        </vs-radio>
                                        <vs-radio v-model="option" val="false">
                        ...
                        <div class="ml-[20px]">
                            ...
                            <div class="flex justify-center items-center">
                                <div>
                                    <vs-switch success style="height: 22px;"> </vs-switch>
                                </div>
                ...
                <div class="ml-[46px] mt-[10px] flex">
                    <div>
                        <div class="flex w-[550px]">
                            <div class="mb-[8px] text-[#2D3349] font-bold text-[12px] w-[70%]">Approval Document (6)</div>
                        ...
                        <div>
                            <vs-tooltip bottom shadow not-hover v-model="activeTooltip2">
                                <div class="w-[128px]">
                                    <img class="w-[128px] h-[32px] cursor-pointer" :src="testUpload"
                                        @click="activeTooltip2 = !activeTooltip2">
                                </div>
                                <template #tooltip>
                                    <div class="m-[10px]">
                                        <div class="flex ">
                        ...
                        <div class="mt-[50px]">
                            ...
                            <vs-tooltip bottom shadow not-hover v-model="activeTooltip3">
                                <div class="w-[128px]">
                                    <img class="w-[128px] h-[32px] cursor-pointer" :src="testUpload"
                                        @click="activeTooltip3 = !activeTooltip3">
                                </div>
                                <template #tooltip>
                                    <div class="m-[10px]">
                                        <div class="flex ">
            ...
            <div class="flex justify-between mt-[5px]">
                ...
                <div>
                    <button
                        class="h-[38px]text-[center] rounded-[6px] bg-[#3C7CFC] text-[white] text-[12px] pl-[12px] pb-[6px] pr-[12px] pt-[6px]">Create
...
<script>
import testUpload from '@/assets/image/test-upload.png'
...
export default {
    data() {
        return {
            ...
            activeTooltip3: false,
            activeTooltip4: false,
            tagArr: [],

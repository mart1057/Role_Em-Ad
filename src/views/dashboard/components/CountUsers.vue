    ...
    <div class="w-[100%] h-[238px] flex flex-col justify-between">
        <div class="flex flex-col justify-center items-center">
            <div class=" flex items-center w-[100%] h-[46px] bg-[#4FBD9E] rounded-[10px] justify-between">
                ...
                <div class="mr-[10px] text-[20px] text-white font-bold">100</div>
            </div>
        ...
        <div class="flex justify-between">
            <div class="w-[48%] rounded-[10px] h-[177px] bg-white flex  flex-col">
                <div class="flex justify-center">
                    <div class="w-[50px] rounded-[100px]  text-center h-[20px] font-medium bg-[#3C7CFC] text-[12px] mt-[18px] text-white">Owner</div>
                </div>
                ...
                <div class="flex justify-center">
                    <button class="w-[82px] rounded-[100px] text-center h-[26px] font-medium bg-[#79ACF9] text-[12px] mt-[30px] text-white">View More</button>
                </div>   
            </div>
            <div class="w-[48%] rounded-[10px] h-[177px] bg-white flex  flex-col">
                <div class="flex justify-center">
